...
@Component({
  selector: 'app-driving-license-request',
  templateUrl: './driving-license-request.component.html',
  styleUrls: ['./driving-license-request.component.scss', '../user-request-info.component.scss']
})
export class DrivingLicenseRequestComponent implements OnInit {
